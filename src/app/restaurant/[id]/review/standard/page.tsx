...
const StandardReviewForm = ({ params }: StandardReviewPageProps) => {
  ...
  return (
    ...
    >
      ...
      <section className="mt-[32px] flex w-[692px] flex-col rounded-[50px] bg-[#FDF8F6] p-[40px] lg:w-[772px]">
      ...
      <section className="mt-[32px] flex gap-[16px] lg:gap-[20px]">
      ...
      <section className="my-[32px] h-[213px] w-[692px] rounded-[50px] bg-[#FDF8F6] p-[40px] lg:w-[772px]">
      ...
      <div className="flex w-[692px] justify-end lg:w-[772px]">
        <button
