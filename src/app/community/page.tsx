    ...
    <>
      <div>
        <section className="mt-[64px] min-w-[1200px] bg-[#F4F4F5]">
          <div className="mx-auto w-[1280px] px-[40px] py-[75px]">
        ...
        <section className="min-w-[1200px]">
          <div className="relative mx-auto w-[1280px] px-[40px] py-[80px]">
            ...
            <div className="absolute right-[40px] top-[-110px] z-[99] flex w-[322px] flex-col gap-[10px] rounded-[20px] bg-white p-[20px] shadow-[0_0_10px_0_rgba(0,0,0,0.15)]">
              <div className="relative">
                ...
                <div>
                  ...
                  <div className="mt-[20px] flex h-[54px] w-full justify-between self-stretch rounded-[12px] border border-[#C7C7CC]">
                  ...
                  <div className="mt-[10px] flex items-center justify-center gap-2 self-stretch">
                    <Link
                      href=""
                      className="flex h-[41px] flex-[1_0_0] items-center justify-center gap-1 rounded-[8px] bg-[#FA4D09] p-[10px_20px] text-center text-[16px] font-medium leading-[130%] tracking-[0.16px] text-[#fff]"
                    >
                      컬렉션 만들기
                    </Link>
                    <Link
                      href=""
                      className="flex h-[41px] flex-[1_0_0] items-center justify-center gap-1 rounded-[8px] border border-[#FA4D09] bg-white p-[10px_20px] text-center text-[16px] font-medium leading-[130%] tracking-[0.16px] text-[#FA4D09]"
                    >
                      잇터톡 글쓰기
                    </Link>
                  </div>
              ...
              {!user && (
                <div className="absolute inset-0 z-[100] flex items-center justify-center rounded-[20px] bg-white/60 px-[12px] py-[24px] text-center backdrop-blur-sm">
                  <div className="flex flex-col gap-[10px]">
                    <p className="text-[16px] font-medium leading-[130%] text-[#171719]">
                      로그인하고
                      <br />첫 글을 작성해보세요!
                    </p>
                    <Link
                      href="/signin"
                      className="rounded-[8px] bg-[#FA4D09] px-5 py-2 text-[16px] font-medium text-white"
                    >
                      로그인 하러가기
                    </Link>
                  </div>
